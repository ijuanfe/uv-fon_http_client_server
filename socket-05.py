#!/usr/bin/python
#
# Universidad del valle - Octubre 10 2017
# Asignatura:   Fundamentos de Redes
# Autor:        Juan Felipe Orozco Escobar
# Codigo:       1426244
# Proposito:    Complete el codigo, en la seccion que dice
#               COMPLETE de acuerdo al enunciado dado en
#               este enlace https://goo.gl/1uQqiB, item 'socket-http-client'
